...
public class VenueServiceTest {
	...
	public void venueServiceTest(){
		...
		Mockito.when(util.getJSONForObject(venueList)).thenReturn("Dionysis Park");
		...
		//fail("Not currently implemented fully"); //Doesn't work correctly, so left out.
	}
}
