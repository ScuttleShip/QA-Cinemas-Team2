...
insert into movie(movie_id, certification, description, duration, genre, title, filmImg) values (6, 'PG', 'Bruce Wayne must not only deal with the criminals of Gotham City, but also the responsibility of raising a boy he adopted.', '02:30:00', 'Superhero', 'Lego Batman', 'imgs\legobatman.jpg');
/*insert into movie(movie_id, certification, description, duration, genre, title, filmImg) values (7, '12A', 'European mercenaries searching for black powder become embroiled in the defense of the Great Wall of China against a horde of monstrous creatures.', '02:30:00', 'Monster', 'The Great Wall', 'imgs\greatwall.jpg'); */
insert into venue(venue_id, name, venueimg, venue_address_id) values(1,'QA Newcastle','imgs/venue1pic.jpg',1);
insert into venue(venue_id, name, venueimg, venue_address_id) values(2,'QA Leeds','imgs/venue2pic.jpg',2);
insert into venue(venue_id, name, venueimg, venue_address_id) values(3,'QA Manchester','imgs/venue3pic.jpg',3);
